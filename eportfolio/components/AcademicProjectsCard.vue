<template>
  ...
  <div>
    ...
    >
        <v-col cols="auto">
            <v-card-title class="font-weight-bold">Academic Projects</v-card-title>
    ...
    >
      <v-col align="center" cols="auto">
        <v-card-title class="font-weight-bold">Scalable Movie Recommendation System</v-card-title>
         <v-img
            height="400"
            width="550"
            src="/movie-rec.png"
