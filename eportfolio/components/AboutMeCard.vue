        ...
        >
            <v-col cols="11" class="ml-7">
                <p>
                    ...
                    I am a final year student studying a <strong>Bachelor of Software Engineering</strong> / <strong>Diploma in Professional Engineering Practice</strong> at UTS, sub majoring in <strong>data analytics</strong>. <br><br>
