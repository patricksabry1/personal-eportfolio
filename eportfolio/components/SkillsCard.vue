  ...
  >
    ...
    <div>
       ...
       <v-row
        ...
        >
            <v-col cols="auto">
                <v-card-title class="font-weight-bold">Technical Skills</v-card-title>
            </v-col> 
        </v-row>
        <v-row
            align="center"
        ...
        >
            <v-col cols="auto">
                <v-card-title class="font-weight-bold">Transferable Skills</v-card-title>
            </v-col> 
        </v-row>
        <v-row
            align="center"
        ...
        >
            <v-col cols="11" class="ml-7">                
                 <v-list>
                  <v-list-item
                    v-for="(skill, i) in transferableSkills"
                    :key="i"
                    text
                  >
                    <p>
